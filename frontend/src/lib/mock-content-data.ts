...
export const MOCK_CONTENT_RECORDS: ContentRecord[] = [
  ...
  "geo": {
    ...
    "longitude": 55.6497
      ...
      googleReviews: [
        { reviewer: "James M.", rating: 5, text: "Absolutely incredible experience! The dune bashing was thrilling and the BBQ dinner was delicious. Our guide was very knowledgeable and friendly. Highly recommend!", date: "2026-03-10T00:00:00Z" },
        { reviewer: "Sophie L.", rating: 4, text: "Great safari experience with beautiful sunset views. The camel ride was a highlight. Food was good but could have more variety. Overall a wonderful evening.", date: "2026-03-05T00:00:00Z" },
        { reviewer: "Raj P.", rating: 5, text: "Best desert safari in Dubai! The entertainment at the camp was amazing. The belly dance and tanoura show were mesmerizing. Worth every dirham.", date: "2026-02-28T00:00:00Z" },
        { reviewer: "Anna K.", rating: 3, text: "Nice experience but the pickup was delayed by 30 minutes. The dune bashing was fun though and the camp atmosphere was lovely.", date: "2026-02-20T00:00:00Z" },
      ],
    },
    assignedTo: null,
    status: "pending",
  ...
  "amenityFeature": [
    ...
    { "@type": "LocationFeatureSpecification", "name": "Spa" }
      ...
      googleReviews: [
        { reviewer: "Michael T.", rating: 5, text: "Stunning resort! The Aquaventure waterpark alone is worth the stay. Rooms are luxurious with breathtaking ocean views. The Lost Chambers Aquarium is a must-see.", date: "2026-03-15T00:00:00Z" },
        { reviewer: "Elena R.", rating: 4, text: "Beautiful property with excellent facilities. The restaurants are top-notch, especially Nobu. Only downside is it can get very crowded during peak season.", date: "2026-03-08T00:00:00Z" },
        { reviewer: "David C.", rating: 5, text: "Bucket list hotel! Everything exceeded expectations. The service, the rooms, the beach - all perfect. Kids absolutely loved the waterpark.", date: "2026-02-25T00:00:00Z" },
      ],
    },
    assignedTo: "Sarah K.",
    status: "in_review",
